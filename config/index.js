...
if (env_has_dbconnectionstring === false) {
  ...
  //config.dbconnectionstring = `mongodb://${config.senseboxapiuser}:${config.userpass}@${config.localhost}/OSeM-api?authSource=OSeM-api`;
  //config.dbconnectionstring = `mongodb://${config.admin}:${config.admin}@${config.localhost}/OSeM-api?authSource=OSeM-api`;
}
